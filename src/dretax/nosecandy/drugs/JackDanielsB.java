...
public class JackDanielsB extends BaseDrug
{
	Addict a;

	public JackDanielsB(NoseCandy plugin)
	{
	...
	public boolean onItemInteract(SpoutPlayer player, SpoutBlock block, BlockFace face)
	{
		...
		p.getHandle().addEffect(new MobEffect(2, 600, 5));
		p.getHandle().addEffect(new MobEffect(9, 600, 5));
		p.getHandle().addEffect(new MobEffect(14, 1200, 5));
